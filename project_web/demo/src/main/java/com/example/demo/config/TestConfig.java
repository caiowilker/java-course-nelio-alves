...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product p3 = new Product(null, "Makbook Pro", "Nam eleifend maximus tortor, at mollis.", 1250.0, "");
        ...
        Order o2 = new Order(null, Instant.parse("2019-07-21T07:42:10Z"), OrderStatus.WAITING_PAYMENT, u1);
